...
## Corpus Check
- 28 files · ~41,259 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 485 nodes · 1061 edges · 55 communities detected
- Extraction: 48% EXTRACTED · 52% INFERRED · 0% AMBIGUOUS · INFERRED: 557 edges (avg confidence: 0.59)
...
Cohesion: 0.03
Nodes (71): get_cifar100_dataset(), ConvergenceMetrics, DistributedMetrics, EpochMetrics, ExperimentSummary, FaultMetrics, HashRingMetrics, MetricsCollector (+63 more)
...
Cohesion: 0.05
Nodes (19): Enum, ElasticRecaching, NodeStatus, Return runtime metrics for resilience analysis and reporting., HashRing, Write shard to local NVMe cache with atomic rename pattern., Load shard from local cache with verification., Verify shard integrity by loading and checking. (+11 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (50): enforce_determinism(), Force deterministic behavior to isolate bit-flip impact from training noise., Save a checkpoint.          Args:             model: The model to save (or DD, Record where a checkpoint was loaded from., Record detected fault., Record that a resume was attempted., Record a successful resume event and its rollback characteristics., Record the last observed failure state. (+42 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (17): download_faceforensics_dataset(), get_faceforensics_transforms(), precompute_face_crops(), preextract_frames(), process_batch(), FaceForensics++ dataset loader with MTCNN face detection.  Provides: - FaceFo, Process a batch of images through MTCNN., Load samples from pre-computed crop cache. (+9 more)

### Community 5 - "Community 5"
Cohesion: 0.12
Nodes (7): FaultDetector, Broadcast heartbeat signals to all peers using dist.all_reduce.          Returns, Gather suspicion votes from all ranks using dist.all_gather.          Returns ag, Start background thread for periodic heartbeat broadcast.          Args:, Stop the heartbeat thread gracefully.          Args:             timeout: Maximu, Background loop that periodically broadcasts heartbeats., Get a summary of node statuses.          Returns:             Dict with 'alive',

### Community 6 - "Community 6"
Cohesion: 0.21
Nodes (7): ABC, CheckpointStrategy, CheckpointStrategyFactory, create(), EpochStrategy, FixedIntervalStrategy, YoungDalyStrategy

### Community 7 - "Community 7"
Cohesion: 0.23
Nodes (2): Load the latest checkpoint and restore model/optimizer state.          Args:, str
...
- **Thin community `Community 17`** (2 nodes): `main()`, `main.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (2 nodes): `.get_runtime_metrics()`, `Return checkpoint-manager runtime metrics in a hash-ring-compatible shape.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (2 nodes): `.__len__()`, `Return the number of samples in the dataset.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `Return the number of videos in the dataset.`, `.__len__()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `Get frames from a single video.          Returns:             tuple: (frames_`, `.__getitem__()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (1 nodes): `train_convergence_hashring.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (1 nodes): `train_convergence_normal.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (1 nodes): `train_epoch_based.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (1 nodes): `train_hashring_epoch.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `Check if running in distributed mode.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `Save a checkpoint.          Args:             model: The model to save (or DD`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (1 nodes): `Load the latest checkpoint and restore model/optimizer state.          Args:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `Fault injection and recovery metrics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 42`** (1 nodes): `Record local cache hit.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `Record local cache miss.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `Record shard recovery event.                  Args:             recovery_time`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `Record injected fault.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `Record detected fault.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `Record recovery attempt.                  Args:             success: Whether`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `Record checkpoint integrity check failure.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `Set distributed training configuration.                  Args:             wo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `Record collective synchronization operation.                  Args:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `Increment batch counter.                  Args:             samples: Number o`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `Generate final summary metrics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `Get all epoch metrics as dictionaries for export.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Get current state snapshot for debugging.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `main()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`?**
  _High betweenness centrality (0.391) - this node is a cross-community bridge._
- **Why does `MetricsCollector` connect `Community 0` to `Community 3`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 8`?**
