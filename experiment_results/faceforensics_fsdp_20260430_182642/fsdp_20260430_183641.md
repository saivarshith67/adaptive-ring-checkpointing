# Experiment Report: faceforensics_fsdp_20260430_182642

**Training Mode:** fsdp  
**Dataset:** faceforensics  
**Model:** efficientnet_b0  
**Configuration:** 20 epochs, batch size 2  
**Generated:** 2026-04-30 18:36:41
...
| Checkpoint Overhead | 0.4% |
| Checkpoint Backend | fsdp |
| Framework-Native Saves | 3 |
| Framework-Native Loads | 1 |
| Artifacts Logged | 0 |
| Framework Delegated | False |
| Last Checkpoint Path | ./checkpoints/fsdp/checkpoint_epoch_20.pt |
...
| Resume Load Source | fsdp |
| Time to Resume | 77.9s |
