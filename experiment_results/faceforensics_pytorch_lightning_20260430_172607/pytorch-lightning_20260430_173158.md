# Experiment Report: faceforensics_pytorch_lightning_20260430_172607

**Training Mode:** pytorch-lightning  
**Dataset:** faceforensics  
**Model:** efficientnet_b0  
**Configuration:** 20 epochs, batch size 2  
**Generated:** 2026-04-30 17:31:58
...
| Best Validation Loss | 0.7206 |
| Final Validation Loss | 1.0507 |
| Best Training Loss | 0.2296 |
| Final Training Loss | 0.2296 |
| Total Training Time | 351.1s |
...
| Total Checkpoint Time | 2.1s |
| Checkpoint Overhead | 0.6% |
| Checkpoint Backend | pytorch-lightning |
| Framework-Native Saves | 3 |
| Framework-Native Loads | 1 |
| Artifacts Logged | 0 |
| Framework Delegated | False |
| Last Checkpoint Path | ./checkpoints/pytorch_lightning/checkpoint_epoch_20.pt |
...
| Last Load Source | pytorch-lightning |
...
| Resume Load Source | pytorch-lightning |
| Time to Resume | 74.2s |
