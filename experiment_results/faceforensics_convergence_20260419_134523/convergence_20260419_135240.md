# Experiment Report: faceforensics_convergence_20260419_134523

**Training Mode:** convergence  
**Dataset:** faceforensics  
**Model:** efficientnet_b0  
**Configuration:** 20 epochs, batch size 2  
**Generated:** 2026-04-19 13:52:40
...
| Metric | Value |
|--------|-------|
| Total Checkpoint Count | 10 |
| Total Checkpoint Time | 6.2s |
| Checkpoint Overhead | 1.4% |
...
| Total Convergence Checkpoints | 5 |
| Loss Fit Segments Restarted | 0 |
| Theta1 (Exponential Decay) | -0.0009988919447091519 |
| Theta2 (Exponential Offset) | -1.7392507357555413 |
