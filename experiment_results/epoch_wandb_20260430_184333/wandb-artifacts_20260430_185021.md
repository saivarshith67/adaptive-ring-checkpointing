# Experiment Report: faceforensics_wandb_artifacts_20260430_184333

**Training Mode:** wandb-artifacts  
**Dataset:** faceforensics  
**Model:** efficientnet_b0  
**Configuration:** 20 epochs, batch size 2  
**Generated:** 2026-04-30 18:50:21
...
| Total Checkpoint Time | 2.0s |
| Checkpoint Overhead | 0.5% |
| Checkpoint Backend | wandb-artifacts |
| Framework-Native Saves | 3 |
| Framework-Native Loads | 1 |
| Artifacts Logged | 0 |
| Framework Delegated | False |
| Last Checkpoint Path | ./checkpoints/wandb_artifacts/checkpoint_epoch_20.pt |
...
| Last Load Source | wandb-artifacts |
...
| Resume Load Source | wandb-artifacts |
| Time to Resume | 78.7s |
